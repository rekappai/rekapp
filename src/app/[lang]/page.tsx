...
export default async function HomePage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const loc = ({ en: 'en-GB', it: 'it-IT', fr: 'fr-FR', es: 'es-ES' }[lang] || 'en-GB')
      ...
      <div className="page">
        ...
        <div className="feed-layout">
          <div className="feed-col">
            ...
            {articles.length === 0 && (
              <div className="empty-state">{({ en: 'No articles available yet.', it: 'Nessun articolo disponibile.', fr: 'Aucun article disponible.', es: 'No hay artículos disponibles.' }[lang] || 'No articles available yet.')}</div>
            )}
